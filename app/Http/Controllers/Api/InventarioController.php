...
public function store(Request $request){ // Crear nuevo producto con stock inicial en una sucursal
    ...
    $validatedData = $request->validate([
       ...
       //Gestion de E/S de infates , con nombre,edad,genero,tutot,hora de entrada y salida  y tenemos registroo de infantes/hora que llegan - se van con el tutor y reporte de E/S de infantes
    ]);
...
{  // Lógica para actualizar un producto existente
    ...
    $validatedData = $request->validate([
        ...
        'id_sucursal'  => 'sometimes|integer|exists:sucursales,id_sucursal',

    ]);

    $producto->update($validatedData);// Actualizamos el producto con los datos validados
    ...
    public function destroy($id_producto)
    {
        ...
        // "eliminar" el producto cambiando su estado a 'desactivado'
